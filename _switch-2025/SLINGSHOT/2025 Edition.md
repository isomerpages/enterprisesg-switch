...
<img style="width: 100%" height="auto" width="100%" alt="Graphic banner of a man pitching on stage to a crowd with the text &quot;Power to Scale&quot;" src="/images/SLINGSHOT/SLINGSHOT 2025/slingshot_2025_masthead_2500x700.jpg">
</div>

## Ready to slingshot your startup into the world through Singapore?

Compete for grant prizes worth over S$2 million when you take the global stage under SLINGSHOT 2025’s spotlight from 29-31 October and showcase your trailblazing solutions to the world!
...
Ready to take on the world? <a href="https://slingshot.agorize.com/en/challenges/2025-edition?t=O-aGtYHNpSO6QgTMj0cfFQ&amp;utm_source=esg_switchweb&amp;utm_medium=internal_webups&amp;utm_campaign=slingshot2025&amp;utm_content=esglaunch_organic" rel="noopener nofollow" target="_blank">Find out more here</a>

### SLINGSHOT Competition Domains:
  ...
  <tbody><tr>
   ...
   <tr>
    ...
    <td style="border: 0px solid #CCCCCC; padding: 10px;">Register on the platform and submit your presentation <a target="_blank" href="https://slingshot.agorize.com/en/challenges/2025-edition?t=O-aGtYHNpSO6QgTMj0cfFQ&amp;utm_source=esg_switchweb&amp;utm_medium=internal_webups&amp;utm_campaign=slingshot2025&amp;utm_content=esglaunch_organic"> here</a></td>
		...
		<section id="slingshot-top-60" class="section">
  <div class="container">
    ...
    <label for="tableFilter" style="display:block;margin:1rem 0 .25rem;font-weight:600;">Filter by keyword</label>
    <input id="tableFilter" type="text" placeholder="Search name, keywords…" style="max-width:420px;width:100%;padding:.6rem .8rem;border:1px solid #ddd;border-radius:8px">

    <style>
      .domain-block{margin:2.5rem 0}
      .domain-block h2{margin:1.5rem 0 .75rem}
      .slingshot-table{width:100%;border-collapse:separate;border-spacing:0;overflow:hidden;border-radius:12px;border:1px solid #e5e7eb}
      .slingshot-table thead th{background:#f8fafc;text-align:left;font-weight:700;padding:.9rem .9rem;border-bottom:1px solid #e5e7eb}
      .slingshot-table tbody td{vertical-align:top;padding:.9rem .9rem;border-top:1px solid #f1f5f9}
      .slingshot-table tbody tr:first-child td{border-top:none}
      .startup-name a{text-decoration:none}
      .muted{color:#64748b;font-size:.9rem}
      @media (max-width: 768px){
        .slingshot-table thead{display:none}
        .slingshot-table, .slingshot-table tbody, .slingshot-table tr, .slingshot-table td{display:block;width:100%}
        .slingshot-table tr{border-bottom:1px solid #e5e7eb}
        .slingshot-table td{border:none;border-top:0;padding:.5rem .9rem}
        .slingshot-table td[data-label]{padding-top:.85rem}
        .slingshot-table td::before{content:attr(data-label);display:block;font-weight:600;color:#475569;margin-bottom:.25rem}
      }
    </style>
    ...
    <div class="domain-block" id="domain-eegt">
      ...
      <table class="slingshot-table">
        ...
        <tbody>
          ...
          <tr><td class="startup-name" data-label="Startup"><a href="https://www.okosix.com/" target="_blank" rel="noopener">OKOsix</a></td><td data-label="Elevator Pitch">Fully biodegradable, low-carbon materials replacing fossil plastics—applications from surgical/beauty masks to diapers; Geneva Inventions Gold Medal.</td></tr>
    ...
    <p class="muted">If any website URLs change, simply update the <em>href</em> on the corresponding row above.</p>
  </div>
</section>
